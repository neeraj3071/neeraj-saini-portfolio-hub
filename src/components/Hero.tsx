...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center bg-primary relative overflow-hidden">
      ...
      <div className="absolute top-20 right-20 w-64 h-64 bg-purple rounded-full blur-[120px] opacity-40"></div>
      <div className="absolute bottom-20 left-20 w-80 h-80 bg-pink rounded-full blur-[120px] opacity-30"></div>

      {/* Floating stickers */}
      <div className="absolute top-[15%] right-[10%] text-5xl float-sticker sticker rounded-2xl bg-white p-3" style={{ animationDelay: "0s" }}>🚀</div>
      <div className="absolute top-[60%] left-[8%] text-5xl float-sticker-reverse sticker rounded-2xl bg-white p-3" style={{ animationDelay: "1s" }}>💻</div>
      <div className="absolute bottom-[20%] right-[20%] text-4xl float-sticker sticker rounded-2xl bg-white p-3" style={{ animationDelay: "2s" }}>⚡</div>
      <div className="absolute top-[30%] left-[15%] text-4xl float-sticker-reverse sticker rounded-2xl bg-white p-3" style={{ animationDelay: "0.5s" }}>🔥</div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in">
            ...
            {/* Big headline */}
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-display font-bold text-deep leading-[0.95] mb-6">
              building{" "}
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              <button
                ...
                className="bg-deep text-white px-8 py-4 rounded-full font-display font-bold text-lg brutal-border brutal-shadow bouncy flex items-center gap-2"
              >
              ...
              <button
                ...
                className="bg-white text-deep px-8 py-4 rounded-full font-display font-bold text-lg brutal-border brutal-shadow bouncy flex items-center gap-2"
              >
