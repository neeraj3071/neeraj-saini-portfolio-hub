        ...
        <div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center mb-20">
          ...
          <div className="flex justify-center">
            <div className="relative tilt-neg-2">
              <div className="w-56 h-56 sm:w-64 sm:h-64 rounded-brutal overflow-hidden brutal-border brutal-shadow-lg">
                <img
                  src={profilePhoto}
          ...
          <div className="space-y-6">
            <h3 className="text-2xl sm:text-3xl font-display font-bold text-deep">
              full-stack software engineer
            </h3>
            <p className="text-base sm:text-lg font-body text-deep/70 leading-relaxed">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {stats.map((stat, index) => {
            ...
            return (
              <div
                key={stat.label}
                className={`${stat.bg} ${tilts[index]} brutal-border brutal-shadow-lg rounded-brutal p-6 sm:p-8 text-center bouncy`}
              >
                <Icon className="w-10 h-10 mx-auto mb-3" />
                <div className="text-4xl sm:text-5xl font-display font-bold mb-2">{stat.value}</div>
